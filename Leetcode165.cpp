...
public:
    int compareVersion(string version1, string version2) {
        ...
        string s1="", s2 = "";
        while (version1[index1] != '.'&&index1<version1.size()) { s1 += version1[index1++]; continue; };
        while (version2[index2] != '.'&&index2<version2.size()) { s2 += version2[index2++]; continue; };
        v1 = atoi(s1.c_str());
        v2 = atoi(s2.c_str());
        index1++;
        index2++;
        if (v1 > v2) {
            ...
            while (index1 < version1.size() || index2 < version2.size()) {
                ...
                s1 = "";
                s2 = "";
                while (index1 < version1.size()&&version1[index1] != '.') { s1 += version1[index1++]; continue; };
                while (index2<version2.size()&& version2[index2] != '.') { s2 += version2[index2++]; continue; };
